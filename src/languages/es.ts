...
export default {
  ...
  player: {
    ...
    playlistAdded:
      'Añadida la playlist **[`{name}`]({uri})** ({count} pistas) a la cola.',
  ...
  grab: {
    ...
    dmError:
      'No pude enviarte un DM. Por favor verifica tu configuración de privacidad.',
  ...
  jump: {
    ...
    specifyPositionOrName:
      'Por favor especifica un número de posición o nombre de canción'
  },
  // Nombres de filtros
  filters: {
    '8d': '8D',
  ...
  karaoke: {
    ...
    sessionAlreadyActive:
      'Ya existe una sesión de karaoke activa en este servidor. Espera a que termine o usa el comando nuevamente para detener la sesión actual.',
    noLyricsAvailable:
      'No hay letras sincronizadas disponibles. Prueba con una canción diferente.',
  ...
  roulette: {
    playingRandom:
      '🎲 Reproduciendo pista aleatoria: **{title}** por **{author}**',
...
¿No quieres más? [\`Haz clic aquí para invitarme\`](https://discord.com/oauth2/authorize?client_id=1202232935311495209)`,
  ...
  playlist: {
    create: {
      ...
      nameTooLong:
        'El nombre de la playlist debe tener menos de {maxLength} caracteres.',
    ...
    add: {
      ...
      nothingAddedDesc:
        'No se añadieron pistas nuevas. Pueden ya existir en la playlist o no se encontraron coincidencias.',
    ...
    view: {
      ...
      gettingStartedDesc:
        '¡Usa `/playlist create` para hacer tu primera playlist!',
    ...
    play: {
      ...
      noVoiceChannelDesc:
        'Únete a un canal de voz para reproducir una playlist',
      ...
      playFailedDesc:
        'No se pudo reproducir la playlist. Por favor intenta más tarde.'
    },
    remove: {
      notFound: 'Playlist No Encontrada',
      notFoundDesc: '¡No existe una playlist llamada "{name}"!',
    ...
    import: {
      ...
      invalidFileDesc:
        'El archivo debe contener una playlist válida con nombre y array de pistas.',
